...
<head>
	...
	<meta name="theme-color" content="#198df7">
	<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
	<meta name="apple-mobile-web-app-capable" content="yes">
	<meta name="mobile-web-app-capable" content="yes">
	<meta name="HandheldFriendly" content="True">
	<meta name="MobileOptimized" content="320">
	<link rel="icon" href="{{ asset('code_live.png')}} " type="image/x-icon" />
	<link rel="shortcut icon" type="image/x-icon" href="{{ asset('favicon.ico')}}" />
	<!-- Generated: 2018-04-16 09:29:05 +0200 -->
	<title>Sistem Pembayaran Menara Ilmu</title>
				...
				<div class="container">
					<div class="d-flex">
						<a class="header-brand" href="{{ route('web.index') }}">
							<h3 class="mt-2" style="margin-bottom: 10px !important">SISTEM PEMBAYARAN MENARA ILMU</h3>
						...
						<div class="d-flex order-lg-2 ml-auto">
							<div class="dropdown">
								<a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
									<span class="avatar"
										style="background-image: url({{ asset("code_live.png")}})"></span>
			...
			<div class="container">
				<div class="row align-items-center flex-row-reverse">
					<div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
						Copyright © 2020 Theme by <a href="https://codecalm.net"
							target="_blank">codecalm.net</a> Used and Modified By LARAVEL</a> All rights reserved.
					</div>
				</div>
			</div>
		</footer>
