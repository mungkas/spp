            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        ...
                        <a href="{{ route('siswa.export') }}" class="btn btn-secondary btn-sm ml-2" download="true">Send Mail</a>
                    </div>
                    ...
                    <table class="table card-table table-hover table-vcenter text-nowrap">
                        ...
                        @foreach ($siswa as $index => $item)
                            <tr>
                                ...
                                <td> {{ $item->jenjang->nama }}{{ isset($item->jenjang->periode) ? "(".$item->jenjang->periode->nama.")" : ''}}</td>
