                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <select id="select-beast" class="form-control custom-select" name="jenjang_id">
                                    @foreach($jenjang as $item)
                                        <option value="{{ $item->id }}" {{ isset($siswa) ? ($item->id == $siswa->jenjang_id ? 'selected' : '') : '' }}>{{ $item->nama }} - {{ isset($item->periode) ? $item->periode->nama : '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nis" placeholder="NIS" value="{{ isset($siswa) ? $siswa->nis : old('nama') }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="email" placeholder="Email" value="{{ isset($siswa) ? $siswa->email : old('email') }}" required>
                            </div>
                            <div class="form-group">
