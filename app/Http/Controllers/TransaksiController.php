...
class TransaksiController extends Controller
{
    ...
    public function store(Request $request,Siswa $siswa)
    {
        ...
        if($transaksi->save()){
            ...
            $keuangan = Keuangan::create([
                ...
                'jumlah' => $jumlah,
                'total_kas' => $total_kas,
                'keterangan' => 'Pembayaran SPP "LUNAS" Oleh '.$transaksi->siswa->nama.' pada tanggal '.$transaksi->created_at.' dengan catatan : dibayarkan dengan '.$request->via.
                                ', '.$request->keterangan
            ]);
        }
        ...
        if($request->via == 'tabungan'){
            ...
            $keuangan = Keuangan::create([
                ...
                'jumlah' => $menabung->jumlah,
                'total_kas' => $jumlah,
                'keterangan' => 'Transaksi tabungan oleh '. $menabung->siswa->nama."(".$menabung->siswa->jenjang->nama.")".
    ...
    protected function getTagihan(Siswa $siswa)
    {
        ...
        $tagihan = array_merge($tagihan_wajib, $tagihan_jenjang, $tagihan_siswa);
